...
import { categories, getCategory, getAvailableProducts, getBrands } from "../../../lib/catalog";
...
export default async function CategoryPage({ params, searchParams }) {
  ...
  const allItems = getAvailableProducts().filter((product) => product.categorySlug === slug);
