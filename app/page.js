...
export default function Home(){
  return <><BrandHeader/><main>
    <section className="hero"><div className="container hero-grid">
      <div className="hero-copy-block"><p className="eyebrow">CANACONA • GOA</p><h1>Everything you need to finish the job.</h1>
      <p className="hero-copy">Paints, hardware, tools and everyday project essentials — available locally in Canacona.</p>
      <div className="actions"><Link href="/products" className="button primary">Browse products</Link><a href="https://wa.me/919999999999" target="_blank" className="button">Ask on WhatsApp</a></div>
      <div className="hero-meta"><span>Local store</span><span>Genuine products</span><span>Helpful advice</span></div></div>
      <div className="hero-visual"><div className="visual-label"><small>Featured range</small><strong>Opus Paints</strong><span>Explore selected products available at the store.</span></div></div>
    </div></section>
