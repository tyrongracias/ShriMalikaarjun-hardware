...
export const products = [
  ...
  description:
    "Protect and elevate your exterior surfaces with our Water-Based Clear Coat for Exterior Textures.",

  longDescription:
    "Engineered to resist weathering and algal growth, it keeps surfaces looking fresh with minimal upkeep. Designed to preserve design aesthetics, it maintains the original beauty of textured finishes. With a 5-year performance warranty, it’s the smart choice for lasting protection and clean, enduring appeal.",

  image: "/images/products/one-inspire-clear-coat-packshot.webp",
