...
export const products = [
  {
    slug: "opus-exterior-paint",
    name: "Opus Exterior Paint",
    short: "OPUS",
    brand: "Opus",
    category: "Paints",
    categorySlug: "paints",
    ...
    tone: "terracotta",
    description: "Protect and elevate your exterior surfaces with our Water-Based Clear Coat for Exterior Textures..",
    longDescription: " Engineered to resist weathering and algal growth, it keeps surfaces looking fresh with minimal upkeep. Designed to preserve design aesthetics, it maintains the original beauty of textured finishes. With a 5-year performance warranty, it’s the smart choice for lasting protection and clean, enduring appeal.",
    image: "https://www.birlaopus.com/paint-products/exterior-wall-paint/one-inspire-clear-coat",
    available: true,
    featured: true,
  },
  {
    slug: "one-inspire-clear-coat",
