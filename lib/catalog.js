...
export const products = [
  {
    ...
    tone: "terracotta",
    description: "Exterior paint for durable, attractive finishes.",
    longDescription: "A featured Opus exterior paint product. Contact the store for current colours, pack sizes, availability and pricing.",
    image: null,
    available: true,
    featured: true,
  },
  {
    slug: "opus-interior-paint",
    name: "Opus Interior Paint",
    short: "OPUS",
    brand: "Opus",
    category: "Paints",
    categorySlug: "paints",
    ...
    longDescription: "A featured Opus interior paint product. Contact the store for current colours, pack sizes, availability and pricing.",
    image: null,
    available: true,
    featured: true,
  },
